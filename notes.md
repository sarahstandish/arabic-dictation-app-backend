...
# Google Cloud API
- audio content is sent as a string encoded in base64.  This is because JSON is a text format and doesn't directly support binary data.  This makes me think that I also need to send it back in base64.  It must be converted from base64 to binary before it can be played on a device.  I will need to prep for how to best recieve that data in React.
...
Voice to text REST API: https://cloud.google.com/text-to-speech/docs/reference/rest/v1/text/synthesize
...
- Create /words/id route
- Get word by ID
- Get audio object from Google
- Send it out through the API
- Write tests
- Read about content-type header
- Read about how to return an audio object via Flask??
